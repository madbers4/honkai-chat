    ...
    <main className="staff-page">
      ...
      <div className="staff-rules">
        ...
        <p>
          ...
          попытки закончились, — в истории срабатывает — раунд проигран.
          ...
          <>
            ...
            {finished && ready && (
              ...
              >
                ...
                <p>
                  {game.phase === "won"
                    ? "Ты обезвредил — и лишил Искру спецэффектов. Зато обеспечил ей хороший финал."
                    : game.lossReason === "time"
                      ? "Даже дополнительная минута прошла — — сработала. Искра уже придумывает заголовок."
