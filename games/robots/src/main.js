...
document.querySelector('.keyboard-guide').insertAdjacentHTML('beforebegin', `
  ...
  <div class="move-book"><div class="eyebrow">СВЯЗКИ И СПОСОБНОСТИ</div>
    ...
    <div class="overload-recipe"><span>80 ЭНЕРГИИ <b>→</b> НАЖМИ ПЕРЕГРУЗКУ</span><p>Зарядка длится 1,85 секунды: кольцо сжимается, затем три разряда накрывают всю арену. Щит выдерживает урон обычной серии из трёх ударов; импульс или мина сбивают его сразу и прерывают ульту. По сигналу «ПРЫГАЙ» веди джойстик вверх или держи полный блок. Приседание и отход к краю от разряда не спасут.</p></div>
  </div>`);
