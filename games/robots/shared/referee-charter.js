...
export const REFEREE_REMINDERS = Object.freeze([
  ...
  {title:'Объявление',text:'Представь обоих бойцов, прочитай устав и короткие правила боя. Карточки сменятся сами с запасом времени на чтение. Дай прозвучать диалогу Джотаро и Дио. После него прочитай свою подводку и нажми «Начать раунд» — только тогда пойдёт отсчёт.'},
  {title:'Совершенно беспристрастно',text:'Перед эфиром тайно выбери фаворита по имени. Можно оправдывать его неудачи и переделывать комментарии под своего персонажа. Счёт и попадания объявляй по тому, что произошло на арене.'},
